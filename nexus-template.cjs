...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Rehabilitation Services Management Hub";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Rehabilitation Case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "rehabilitation_case_records";
'use strict';
